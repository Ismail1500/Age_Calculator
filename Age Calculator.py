...
if __name__ == "__main__" :
	...
	dob = Label(gui, text = "DATE OF BIRTH", bg = "green")

	# Create a Given Date : label
	givenDate = Label(gui, text = "TODAY DATE / GIVEN DATE", bg = "green")

	# Create a Day : label
	day = Label(gui, text = "Day = ",bg = "sky blue")

	# Create a Month : label
	month = Label(gui, text = "Month = ",bg = "sky blue")

	# Create a Year : label
	year = Label(gui, text = "Year = ",bg="sky blue")

	# Create a Given Day : label
	givenDay = Label(gui, text = " Day = ",bg = "sky blue")

	# Create a Given Month : label
	givenMonth = Label(gui, text = " Month = ",bg = "sky blue")

	# Create a Given Year : label
	givenYear = Label(gui, text = " Year = ",bg = "sky blue")

	# Create a Years : label
	rsltYear = Label(gui, text = "Years", bg = "sky blue")

	# Create a Months : label
	rsltMonth = Label(gui, text = "Months", bg = "sky blue")

	# Create a Days : label
	rsltDay = Label(gui, text = "Days", bg = "sky blue")

	# Create a Resultant Age Button and attached to calculateAge function
	resultantAge = Button(gui, text = "Calculate Age", fg = "Black", bg = "green", command = calculateAge)

	# Create a Clear All Button and attached to clearAll function
	clearAllEntry = Button(gui, text = "Clear All", fg = "Black", bg = "green", command = clearAll)
